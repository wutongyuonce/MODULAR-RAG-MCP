...
LIVE_API_TESTS_ENABLED = os.getenv("RUN_REAL_API_TESTS") == "1"


def require_live_api_tests() -> None:
    """Skip live ingestion tests unless explicitly enabled."""
    if not LIVE_API_TESTS_ENABLED:
        pytest.skip("Set RUN_REAL_API_TESTS=1 to run live ingestion E2E tests")
