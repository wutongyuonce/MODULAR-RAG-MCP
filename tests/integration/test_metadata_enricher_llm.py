...
Run with: RUN_REAL_API_TESTS=1 pytest tests/integration/test_metadata_enricher_llm.py -v -s
...
pytestmark = pytest.mark.skipif(
    ...
    reason="Set RUN_REAL_API_TESTS=1 to run live LLM integration tests",
)
