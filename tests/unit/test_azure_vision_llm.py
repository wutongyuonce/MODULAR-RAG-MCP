...
@pytest.fixture(name="_azure_env")
def fixture_azure_env(monkeypatch) -> None:
    """Provide default Azure OpenAI credentials for tests that need them."""
...
class TestAzureVisionLLMInit:
    ...
    def test_init_with_env_vars(self, mock_settings, _azure_env):
...
class TestImagePreprocessing:
    ...
    def test_get_image_base64_from_bytes(self, mock_settings, _azure_env, test_image_bytes):
    ...
    def test_get_image_base64_from_base64(self, mock_settings, _azure_env, test_image_base64):
    ...
    def test_get_image_base64_from_path(self, mock_settings, _azure_env, test_image_bytes, tmp_path):
        """Convert image file path to base64."""
        # Create temporary image file
        image_path = tmp_path / "test.png"
        image_path.write_bytes(test_image_bytes)
        
        llm = AzureVisionLLM(mock_settings, allowed_image_root=tmp_path)
    ...
    def test_get_image_base64_rejects_path_outside_allowed_root(
        self, mock_settings, _azure_env, test_image_bytes, tmp_path
    ):
        """Reject local file reads outside the configured image sandbox."""
        outside_dir = tmp_path / "outside"
        outside_dir.mkdir()
        image_path = outside_dir / "secret.png"
        image_path.write_bytes(test_image_bytes)

        llm = AzureVisionLLM(mock_settings, allowed_image_root=tmp_path / "allowed")

        with pytest.raises(AzureVisionLLMError, match="Invalid image path"):
    ...
    def test_preprocess_image_no_compression_needed(self, mock_settings, _azure_env, test_image_bytes):
    ...
    def test_preprocess_image_compression_needed(self, mock_settings, _azure_env):
    ...
    def test_preprocess_image_preserves_aspect_ratio(self, mock_settings, _azure_env):
    ...
    def test_preprocess_image_already_base64(self, mock_settings, _azure_env, test_image_base64):
...
class TestChatWithImage:
    ...
    def test_chat_with_image_basic(self, mock_settings, _azure_env, test_image_bytes):
    ...
    def test_chat_with_image_validates_text(self, mock_settings, _azure_env, test_image_bytes):
        """Validate text input."""
        llm = AzureVisionLLM(mock_settings)
        image = ImageInput(data=test_image_bytes)
    ...
    def test_chat_with_image_validates_image(self, mock_settings, _azure_env):
    ...
    def test_chat_with_image_with_conversation_history(self, mock_settings, _azure_env, test_image_bytes):
    ...
    def test_chat_with_image_kwargs_override(self, mock_settings, _azure_env, test_image_bytes):
    ...
    def test_chat_with_image_api_error(self, mock_settings, _azure_env, test_image_bytes):
    ...
    def test_chat_with_image_malformed_response(self, mock_settings, _azure_env, test_image_bytes):
...
class TestFactoryIntegration:
    ...
    def test_create_vision_llm_from_factory(self, mock_settings, _azure_env):
